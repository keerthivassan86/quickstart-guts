...
boot_guts_source:
	heat stack-create -P name="gsource" -P image=${IMAGE} -P network=${NETWORK_ALOK} -P subnet=${SUBNET_ALOK} -P security_group=${SEC_GRP_ALOK} -P keypair='cloud' -f "heat-templates/devbox.yaml" guts_source
